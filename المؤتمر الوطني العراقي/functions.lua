...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(rany..":NameBot:")
...
elseif  UserID == 1099083018 then
var =  'مطور عام'
elseif redis:sismember(rany..':SUDO_BOT:',UserID) then
var = 'مطور البوت ' 
elseif redis:sismember(rany..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(rany..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء ' 
elseif redis:sismember(rany..'owners:'..ChatID,UserID) then
var = 'مدير البوت ' 
elseif redis:sismember(rany..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت ' 
elseif redis:sismember(rany..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ' 
else
var = 'فقط عضو ' 
end
...
if msg.edited then
redis:incr(rany..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(rany..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(rany..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(rany..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(rany..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(rany..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(rany..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(rany..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(rany..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(rany..':SUDO_BOT:')
message = '-  قائمه الـمـطـوريـن : \n\n`- مطور اساسي`**\n'..SUDO_USER..' « ❪' ..SUDO_ID.. '❫\n*———————— *\n'
if #list==0 then  message = message.."* - لا يوجد مطورين حاليا \n♧*"
else
for k,v in pairs(list) do
local info = redis:hgetall(rany..'username:'..v)
local count = redis:scard(rany..'mtwr_count'..v)
...
local monsha = redis:smembers(rany..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————  \n\n📋│ قائمه المدراء :*\n\n'
local list = redis:smembers(rany..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(rany..'admins:'..msg.chat_id_)
...
local list = redis:smembers(rany..'whitelist:'..msg.chat_id_)
...
if redis:sismember(rany..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(rany..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(rany..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(rany..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(rany..'gban_users')
...
local list = redis:smembers(rany..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(rany..':Filter_Word:'..msg.chat_id_,word) then 
return  "- **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع↯" 
else
redis:sadd(rany..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(rany..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(rany..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(rany..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(rany..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(rany..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(rany..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(rany..'group:ids')
message = '- **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(rany..'group:name'..v)
if info then 
...
redis:del(
rany..'group:add'..id_group,
rany..'lock_link'..id_group, 
rany..'lock_id'..id_group,
rany..'lock_spam'..id_group, 
rany..'lock_webpage'..id_group,
rany..'lock_markdown'..id_group,
rany..'lock_flood'..id_group,
rany..'lock_bots'..id_group,
rany..'mute_forward'..id_group,
rany..'mute_contact'..id_group,
rany..'mute_location'..id_group,
rany..'mute_document'..id_group,
rany..'mute_keyboard'..id_group,
rany..'mute_game'..id_group,
rany..'mute_inline'..id_group,
rany..'lock_username'..id_group,
rany..'num_msg_rany'..id_group,
rany..'replay'..id_group
)
redis:srem(rany..'group:ids',id_group)
end
...
redis:hset(rany..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(rany..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(rany..'group:add'..msg.chat_id_) then  return '•**المجموعه بالتأكيد تم تفعيلها' end
...
redis:setex(rany..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(rany..':addnumberusers') or 0)
...
local lock_service = redis:get(rany..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(rany..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(rany..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
rany..'group:add'..msg.chat_id_,true,
rany..'lock_link'..msg.chat_id_,true, 
rany..'lock_id'..msg.chat_id_,true,
rany..'lock_spam'..msg.chat_id_,true,
rany..'lock_webpage'..msg.chat_id_,true,
rany..'lock_markdown'..msg.chat_id_,true,
rany..'lock_flood'..msg.chat_id_,true,
rany..'lock_bots'..msg.chat_id_,true,
rany..'mute_forward'..msg.chat_id_,true,
rany..'mute_contact'..msg.chat_id_,true,
rany..'mute_location'..msg.chat_id_,true,
rany..'mute_document'..msg.chat_id_,true,
rany..'mute_keyboard'..msg.chat_id_,true,
rany..'mute_game'..msg.chat_id_,true,
rany..'mute_inline'..msg.chat_id_,true,
rany..'lock_username'..msg.chat_id_,true,
rany..'num_msg_rany'..msg.chat_id_,5, 
rany..'replay'..msg.chat_id_,true
)

redis:sadd(rany..'group:ids',msg.chat_id_) 
redis:sadd(rany..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(rany..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(rany..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(rany..'group:add'..msg.chat_id_) then return '- ** المجموعه بالتأكيد تم تعطيلها' end  
...
if redis:sismember(rany..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- انه بالتأكيد منشىء  \n↯',17,USERCAR) 
end
redis:hset(rany..'username:'..UserID,'username',Resolv)
redis:sadd(rany..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح منشىء في البوت \n↯',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(rany..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- انه بالتأكيد ليس منشىء \n↯',17,USERCAR) 
end
redis:srem(rany..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(rany..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- انه بالتأكيد منشىء اساسي \n↯',17,USERCAR) 
end
redis:hset(rany..'username:'..UserID,'username',Resolv)
redis:sadd(rany..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح منشىء اساسي في البوت \n↯',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(rany..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- انه بالتأكيد ليس منشىء اساسي\n↯',17,USERCAR) 
end
redis:srem(rany..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(rany..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- انه بالتأكيد عضو مميز \n↯',17,USERCAR) 
end
redis:hset(rany..'username:'..UserID, 'username', Resolv)
redis:sadd(rany..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح عضو مميز \n↯',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(rany..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- انه بالتأكيد ليس عضو مميز \n↯',17,USERCAR) 
end
redis:srem(rany..'whitelist:'..ChatID,UserID)
...
if redis:sismember(rany..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- انه بالتأكيد مدير \n↯',17,USERCAR) 
end
redis:hset(rany..'username:'..UserID, 'username', Resolv)
redis:sadd(rany..'owners:'..ChatID,UserID)
...
if redis:sismember(rany..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- انه بالتأكيد ادمن \n↯',17,USERCAR) 
end
redis:hset(rany..'username:'..UserID, 'username', Resolv)
redis:sadd(rany..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح ادمن \n↯',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(rany..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- انه بالتأكيد ليس مدير \n↯',17,USERCAR) 
end
redis:srem(rany..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- تم تنزيله من المدير  \n↯',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(rany..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- انه بالتأكيد ليس ادمن \n↯',17,USERCAR) 
end
redis:srem(rany..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(rany..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(rany..'username:'..UserID, 'username', Resolv)
redis:sadd(rany..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- تم حظره  \n↯',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(rany..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- تم بالتأكيد الغاء حظره  \n↯',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- تم الغاء حظره \n↯',17,USERCAR) 
end
redis:srem(rany..'banned:'..ChatID,UserID)
...
if redis:sismember(rany..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- تم بالتأكيد كتمه  \n↯',17,USERCAR) 
end
redis:hset(rany..'username:'..UserID, 'username', Resolv)
redis:sadd(rany..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- تم كتمه \n↯',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(rany..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- تم بالتاكيد الغاء كتمه  \n↯',17,USERCAR) 
end
redis:srem(rany..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- تم الغاء كتمه  \n↯',17,USERCAR) 
end
...
redis:hset(rany..'username:'..UserID, 'username',Resolv)
redis:sadd(rany..'gban_users',UserID)
...
redis:srem(rany..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- تم الغاء حظره العام \n↯',17,USERCAR) 
end
...
if redis:sismember(rany..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- انه بالتأكيد مطور \n↯',17,USERCAR) 
end
redis:hset(rany..'username:'..UserID, 'username', Resolv)
redis:sadd(rany..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- تم ترقيته ليصبح مطور \n↯',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(rany..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- انه بالتأكيد ليس مطور \n↯',17,USERCAR) 
end
redis:srem(rany..':SUDO_BOT:',UserID)
...
redis:hset(rany..'username:'..UserID, 'username', UserName)
redis:sadd(rany..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'- **العضو « ❪ '..UserName..' ❫\n- **الايدي « ❪ `'..UserID..'` ❫\n- **تمت ترقيته ليصبح منشىء في البوت \n↯')
end
...
if redis:sismember(rany..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'- **العضو « ❪ '..UserName..' ❫\n- **الايدي « ❪ `'..UserID..'` ❫\n- **تم بالتأكيد حظره \n↯') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
Restrict(ChatID,UserID,1)
redis:hset(rany..'username:'..UserID, 'username', Resolv)
redis:sadd(rany..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'-العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- تم تقييد آلعضـو بنجآح \n↯',17,USERCAR) 
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(rany..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'-العضو « ❪ '..USERNAME..' ❫\n- الايدي « ❪ '..UserID..' ❫\n- تم فگ تقييد آلعضـو بنجآح \n↯',17,USERCAR) 
end
if cmd == "setwhitelist" then
if redis:sismember(rany..'whitelist:'..ChatID,UserID) then 
...
if cmd == "dn_sudo" then
if not redis:sismember(rany..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'-**العضو « '..USERNAME..' \n-** الايدي « (`'..UserID..'`)\n-**انه بالتأكيد ليس مطور \n✓') end
redis:srem(rany..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'-العضو « ❪ '..USERNAME..' ❫\n-الايدي « ❪ '..UserID..' ❫\n-تم تنزيله من المطورين \n↯',17,USERCAR) 
end
...
if redis:get(rany..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(rany..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(rany..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(rany..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*-* اعدادات المجموعه : \n"
.."\n1-╿التعديل «« "..(redis:get(rany..'lock_edit'..msg.chat_id_) or 'false')
.."\n2-│الروابط «« "..(redis:get(rany..'lock_link'..msg.chat_id_) or 'false')
.."\n3-│التاك «« "..(redis:get(rany..'lock_tag'..msg.chat_id_) or 'false')
.."\n4-│المعرفات «« "..(redis:get(rany..'lock_username'..msg.chat_id_) or 'false')
.."\n5-│التكرار «« "..(redis:get(rany..'lock_flood'..msg.chat_id_) or 'false')
.."\n6-│الكلايش «« "..(redis:get(rany..'lock_spam'..msg.chat_id_) or 'false')
.."\n7-│الويب «« "..(redis:get(rany..'lock_webpage'..msg.chat_id_) or 'false')
.."\n8-│الماركدوان «« "..(redis:get(rany..'lock_markdown'..msg.chat_id_) or 'false')
.."\n9-│بالطرد البوتات «« "..(redis:get(rany..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n10-│البوتات «« "..(redis:get(rany..'lock_bots'..msg.chat_id_) or 'false')
.."\n11-│عدد التكرار «« "..(redis:get(rany..'num_msg_rany'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n-│اعدادات الوسائط :\n"
.."\n*1-│*المتحركه «« "..(redis:get(rany..'mute_gif'..msg.chat_id_) or 'false')
.."\n2-│الدردشه «« "..(redis:get(rany..'mute_text'..msg.chat_id_) or 'false')
.."\n3-│الانلاين «« "..(redis:get(rany..'mute_inline'..msg.chat_id_) or 'false')
.."\n4-│الالعاب ««"..(redis:get(rany..'mute_game'..msg.chat_id_) or 'false')
.."\n5-│الصور «« "..(redis:get(rany..'mute_photo'..msg.chat_id_) or 'false')
.."\n6-│الفيديو «« "..(redis:get(rany..'mute_video'..msg.chat_id_) or 'false')
.."\n7-│البصمات «« "..(redis:get(rany..'mute_audio'..msg.chat_id_) or 'false')
.."\n8-│الصوت «« "..(redis:get(rany..'mute_voice'..msg.chat_id_) or 'false')
.."\n9-│الملصقات «« "..(redis:get(rany..'mute_sticker'..msg.chat_id_) or 'false')
.."\n10-│الجهات «« "..(redis:get(rany..'mute_contact'..msg.chat_id_) or 'false')
.."\n11-│التوجيه «« "..(redis:get(rany..'mute_forward'..msg.chat_id_) or 'false')
.."\n12-│الموقع «« "..(redis:get(rany..'mute_location'..msg.chat_id_) or 'false')
.."\n13-│الملفات «« "..(redis:get(rany..'mute_document'..msg.chat_id_) or 'false')
.."\n14-│الاشعارات «« "..(redis:get(rany..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n15-│الكيبورد «« "..(redis:get(rany..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*-│*اعدادات اخرى : "
.."\n\n*1-│*الترحيب «« "..welcomex
.."\n*2-│*الردود «« "..replayx
...
list_settings = "-`اعدادات المجموعه :` "
.."\n\n-1╿التاك «« "..(redis:get(rany..'lock_tag'..msg.chat_id_) or 'false')
.."\n-2|المعرفات «« "..(redis:get(rany..'lock_username'..msg.chat_id_) or 'false')
.."\n-3|التعديل «« "..(redis:get(rany..'lock_edit'..msg.chat_id_) or 'false')
.."\n-4|الروابط «« "..(redis:get(rany..'lock_link'..msg.chat_id_) or 'false')
.."\n-5|التكرار «« "..(redis:get(rany..'lock_flood'..msg.chat_id_) or 'false')
.."\n-6|الكلايش «« "..(redis:get(rany..'lock_spam'..msg.chat_id_) or 'false')
.."\n-7|الويب «« "..(redis:get(rany..'lock_webpage'..msg.chat_id_) or 'false')
.."\n-8|الماركدوان «« "..(redis:get(rany..'lock_markdown'..msg.chat_id_) or 'false')
.."\n-9|البوتات بالطرد «« "..(redis:get(rany..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n-10|البوتات «« "..(redis:get(rany..'lock_bots'..msg.chat_id_) or 'false')
.."\n-11|عدد التكرار «« "..(redis:get(rany..'num_msg_rany'..msg.chat_id_) or 'false')
.."\n—————————\n*-*اعدادات التقـييد :\n"
.."\n*-1|*التقييد بالتوجيه «« "..(redis:get(rany..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*-2|*التقييد بالصور «« "..(redis:get(rany..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*-3|*التقييد بالروابط «« "..(redis:get(rany..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*-4|*التقييد بالمتحركه «« "..(redis:get(rany..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*-5|*التقييد الفيديو «« "..(redis:get(rany..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
